package com.example.hp.acsapp.contactos.contactodetail;
...
public class ContactoDetailFragment extends Fragment {
    ...
    public static ContactoDetailFragment newInstance(String param1, String param2) {
     return new ContactoDetailFragment();
    }
